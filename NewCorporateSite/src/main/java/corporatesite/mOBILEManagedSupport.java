...
public class mOBILEManagedSupport extends Browser {
...
//		s.selectByIndex(1);
	...
	public static void ManageSupport_SharepointverifyFieldVldMsg() throws Exception
	{
		...
		Thread.sleep(3000);
		String actualemailVld = driver.findElement(By.xpath("//*[@id='wpcf7-f3861-p3563-o1']/form/div[2]/div[2]/div/div/span[1]/span/span")).getText();
